...
/*===============================================================================
  Calibration Constants from Original Library - NOT USED, kept for reference
  ===============================================================================*/
...
/*===============================================================================
  Data Structures - EXACTLY as in original ADE9153AAPI.h
  ===============================================================================*/
 ...
 * 
 * @param dev Pointer to device structure
 * @param data Pointer to energy_regs_t structure to fill
 */
 ...
 * 
 * @param dev Pointer to device structure
 * @param data Pointer to power_regs_t structure to fill
 */
 ...
 * 
 * @param dev Pointer to device structure
 * @param data Pointer to rms_regs_t structure to fill
 */
 ...
 * 
 * @param dev Pointer to device structure
 * @param data Pointer to half_rms_regs_t structure to fill
 */
 ...
 * 
 * @param dev Pointer to device structure
 * @param data Pointer to pq_regs_t structure to fill
 */
 ...
 * 
 * @param dev Pointer to device structure
 * @param data Pointer to acal_regs_t structure to fill
 */
 ...
 * 
 * @param dev Pointer to device structure
 * @param aicc Current channel calibration constant
 * @param avcc Voltage channel calibration constant
 * @return true if successful
 */
 ...
 * 
 * @param dev Pointer to device structure
 * @param data Pointer to temperature_t structure to fill
 */
